...
type ProductDetailProps = { productId: string; productName: string };

export function ProductDetailOrder({ productId, productName }: ProductDetailProps) {
  ...
  return <>
    ...
    {showForm && <div className="order-form-panel"><OrderForm productId={productId} productName={productName} quantity={quantity} /></div>}
  </>;
}
